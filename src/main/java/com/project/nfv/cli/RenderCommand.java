package com.project.nfv.cli;

import com.project.nfv.VpcConfiguration;
...
public class RenderCommand extends ConfiguredCommand<VpcConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<VpcConfiguration> bootstrap,
                       Namespace namespace,
                       VpcConfiguration configuration) throws Exception {
